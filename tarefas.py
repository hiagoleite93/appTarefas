from sys import path, setprofile
from kivy.app import App
from kivy.core import text
from kivy.core.image import load
...
class Menu(Screen):
    ...
    def confirmacao(self, *args, **kwargs):
        ...
        animText = Animation(color=(0,0,0,1)) + Animation(color=(1,1,1,1), duration=0.2)
...
class Assistente(Screen):
    ...
    def mensagem(self, msg, *args):
            ...
            self.respWidget = Tarefa(text='Digitando...')
            self.ids.box.add_widget(self.respWidget)
            self.ids.texto.text = ''
            Clock.schedule_once(self.responder, 2)
...
popSound = SoundLoader.load('sound/pop.mp3')
poppapSound = SoundLoader.load('sound/poppap.mp3')
